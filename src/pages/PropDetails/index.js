    ...
    <IconContext.Provider value={{ color: "#28c092", size: "25px" }}>
      <>
        ...
        <section className="contact-info pb-4">
          <div className="container col-10 mx-auto contact-info-container pb-3">
            <div className="row">
              ...
              <div className="col-md-5 order-2 order-lg-2">
                <div className="float-lg-right float-sm- float-md-left">
                  <p>
                    <span className="icon pr-1">
                      <FaPhoneAlt />
                    </span>
        ...
        <section className="features">
          <div className="feature-container container col-10 mx-auto">
